...
const initialState: InitialProduct = {
    products: [
        ...
        { id: 7, name: 'Name7', url: "https://material.angular.io/assets/img/examples/shiba2.jpg", group: "work", mark: false },
        ...
        { id: 10, name: 'Name10', url: "https://material.angular.io/assets/img/examples/shiba2.jpg", group: "work", mark: false },
        { id: 11, name: 'Name11', url: "https://material.angular.io/assets/img/examples/shiba2.jpg", group: "work", mark: false },
        { id: 12, name: 'Name12', url: "https://material.angular.io/assets/img/examples/shiba2.jpg", group: "work", mark: false },
    ]
}
